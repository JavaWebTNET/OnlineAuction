			...
			<div id="primary" class="content-area">
				...
				<form id="loginForm" class="loginbox" name="loginForm" action="j_spring_security_check" method="post">
                       		<table>  
                        		...
                        		<tr>                      
                            		<th>Username</th>                             
                           			<td> <input type="text" id="username"  name="username" size="15" placeholder="username"/></td>
                       			<tr>
                            		<th>Password</th>                             
                            		<td><input type="password" id="password" name="password" size="15" placeholder="password"/></td>                       		
                        		<tr>
