	...
	<div id="main" class="site-main">
		<div id="main-content" class="main-content">
			<div id="primary" class="content-area">
				...
				<sf:form id="register" method="post" modelAttribute="account" action="reg" enctype="multipart/form-data" >
				<table>
					<tr>
					<th>Username(*): </th>
					<td><sf:input type="text" id="ipid" size="15" path="username" /></td>
					</tr>
					<tr>
					...
					<tr>
					<th>Email(*): </th>
					<td><sf:input type="text" id="ipemail" size="15" path="email" /></td>
					</tr>
					<tr>
					...
					<tr>
					<th>Password(*): </th>
					<td><sf:input type="password" id="ippass" size="15" path="password" /></td>
					</tr>
					<tr>
					...
					<tr>
					<th>Re-Password(*): </th>
					<td><input type="password" id="iprps" size="15" /></td>
					</tr>
					<tr>
